    ...
    messages = [
        {
            ...
            "content": (
                ...
                "**George's Line Analysis:** George's Line is an imaginary line connecting the posterior aspects of the vertebral bodies. It should form a smooth, continuous curve. A disruption in this line, such as a step-off, indicates potential spinal instability and is a critical finding that may require surgical intervention. If you detect a disruption of George's Line in any region, you MUST immediately escalate the situation with a direct and urgent recommendation for a surgical consultation.\n"
                "\n"
